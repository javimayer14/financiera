...
@Component
public class SellOperationStrategy extends AbstractTradingOperation implements IOperationStrategy {
	...
	public void save(OperationDto operation) {
		...
		switch (status) {
		case ENTERED:
			enterOperation(operation, EOperationType.SELL_CURRENCY.getState());
			break;
		case FINALIZED:
